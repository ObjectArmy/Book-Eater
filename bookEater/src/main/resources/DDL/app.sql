...
VALUES
    (2, 'An epic fantasy adventure following the journey of a young hero.', 'The Heroic Quest'),
    (3, 'A heartwarming story about friendship and courage in the face of adversity.', 'The Friendship Chronicles'),
    (4, 'A suspenseful thriller that will keep you on the edge of your seat until the very end.', 'The Silent Witness'),
...
VALUES
    (2,'1991-02-02', 'Bio for user 2', 'user2@example.com', 'Jane', 'Smith', 'password2'),
...
VALUES
    (2, 2, 2, CURRENT_TIMESTAMP, 'Offering "To Kill a Mockingbird" by Harper Lee - a timeless classic!'),
    ...
    (5, 5, 5, CURRENT_TIMESTAMP, 'Offering "Harry Potter and the Sorcerer''s Stone" by J.K. Rowling - perfect for young readers!'),
    (6, 6, 6, CURRENT_TIMESTAMP, 'Offering "The Catcher in the Rye" by J.D. Salinger - a coming-of-age masterpiece.'),
    (7, 7, 7, CURRENT_TIMESTAMP, 'Offering "The Hobbit" by J.R.R. Tolkien - a fantastic adventure awaits!'),
    (8, 8, 8, CURRENT_TIMESTAMP, 'Offering "The Lord of the Rings" trilogy by J.R.R. Tolkien - an epic fantasy journey!'),
    ...
    (11,11, 11, CURRENT_TIMESTAMP, 'Offering "The Chronicles of Narnia" by C.S. Lewis - a magical journey for all ages.'),
    (12,12, 12, CURRENT_TIMESTAMP, 'Offering "Gone with the Wind" by Margaret Mitchell - a sweeping tale of love and loss.'),
    (13,13, 13, CURRENT_TIMESTAMP, 'Offering "The Alchemist" by Paulo Coelho - a philosophical and inspirational novel.'),
    (14,14, 14, CURRENT_TIMESTAMP, 'Offering "The Road" by Cormac McCarthy - a haunting post-apocalyptic story.'),
    (15,15, 15, CURRENT_TIMESTAMP, 'Offering "The Girl with the Dragon Tattoo" by Stieg Larsson - a gripping thriller!');
